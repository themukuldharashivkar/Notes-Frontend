...
export default function Register() {
  return (
    <div className='flex flex-col justify-center min-h-screen w-full bg-gray-800'>
        ...
        <div className='mt-24 bg-gray-800 flex flex-col justify-center m-5'>
            <form className='max-w-[400px] w-full mx-auto rounded bg-gray-900 p-8 px-8'>
                ...
                <div className='flex flex-col text-gray-400 py-2'>
                    <label>Email</label>
                    <input className='rounded bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="text" placeholder='Enter your email' />
                </div>
                <div className='flex flex-col text-gray-400 py-2'>
                ...
                <div className='flex flex-col text-gray-400 py-2'>
                    ...
                    <input className='p-2 rounded bg-gray-700 mt-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="password" placeholder='Re-enter your password' />
                </div>
